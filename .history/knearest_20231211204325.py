...
try:
    ...
    # Penyesuaian Parameter KNN untuk optimasi mendalam
    param_grid_extended = {
    ...
    knn_cv = GridSearchCV(knn, param_grid_extended, cv=5) # Mencari parameter terbaik
    ...
    knn_cv_le = GridSearchCV(knn_le, param_grid_extended, cv=5)
    ...
    # Evaluasi Model
    knn_best_le = KNeighborsClassifier(**best_params_le)
    ...
    print("Best param linear_validation:", best_params_le)
    print("Best score linear_validation:", best_score_le)
    print("Best accuracy linear_validation:", accuracy_best_le)
